...
const server = http.createServer(async (req, res) => {
    ...
    console.log(req.method, parsedUrl.path); // Logging the request method and path for debugging
 
    if (req.method === 'GET' && (parsedUrl.path === '/' || parsedUrl.path === '/milani')) {
        await handleGetRequest(res, parsedUrl);
    } else if (req.method === 'POST' && parsedUrl.path === '/milani') {
        await handlePostRequest(req, res);
    } else if (req.method === 'PUT' && parsedUrl.path.startsWith('/milani/')) {
        await handlePutRequest(req, res, parsedUrl);
    } else if (req.method === 'DELETE' && parsedUrl.path.startsWith('/milani/')) {
